...
export function ByteReader( buffer ) {
 ...
 */
export function concatSWFHeader(buff, swf) {
 ...
 */
export function uncompress(swf) {
 ...
 */
export function readSWFBuff(buff, compressed_buff) {
    buff.seek(0);// start
 ...
 */
export function readSWFTags(buff, swf) {
    var tags = [];
    var tag;
    var tagHeader;
